...
class BrandDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final books = catalogController.allBooks.where((b) => b.publisher == publisherName).toList();
      ...
      body: CustomScrollView(
        ...
        slivers: [
          SliverAppBar(
            ...
            centerTitle: true,
            title: Text(publisherName, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 18)),
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    child: CircleAvatar(radius: 35, backgroundColor: Colors.blue[50],
                      child: Icon(Icons.store, size: 35, color: Colors.blue.shade300)),
                  ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Flexible(child: Text(publisherName,
                        ...
                        Container(
                          ...
                          child: Text("${books.length} cuốn sách",
                ...
                ? SliverToBoxAdapter(
                    child: Center(
                      child: Padding(
                        ...
                        child: Text("Không có sách nào từ nhà xuất bản này",
