  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () => Get.toNamed(AppRoutes.editBankAccount),
        label: const Text(
          'Thêm TK',
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) =>
                _buildBankCard(context, banks[index]),
          );
        },
      ),
    );
    ...
    if (confirm == true) {
      ...
      if (context.mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Đã xóa ${bank.shortName}')));
      }
    }
  }
}
