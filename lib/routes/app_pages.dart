...
abstract class AppPages {
  ...
  static final pages = <GetPage<dynamic>>[
    ...
    GetPage(name: AppRoutes.updateAccount, page: () => const UpdateAccountScreen()),
    GetPage(name: AppRoutes.changeName, page: () => const ChangeNameScreen()),
    GetPage(name: AppRoutes.changeUsername, page: () => const ChangeUsernameScreen()),
    ...
    GetPage(name: AppRoutes.changePhoneNumber, page: () => const ChangePhoneNumberScreen()),
    GetPage(name: AppRoutes.changeGender, page: () => const ChangeGenderScreen()),
    GetPage(name: AppRoutes.changeDateofBirth, page: () => const ChangeDateOfBirthScreen()),

    // ===== Bank & Address Screens =====
    GetPage(name: AppRoutes.myBankAccountview, page: () => MyBankAccountScreen()),
    GetPage(name: AppRoutes.myShippingAddressview, page: () => MyShippingAddressScreen()),
  ];
}
